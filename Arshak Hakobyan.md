...
bigint(ES6) --- MAX SAFE INT ից մեծ թվերին են որոնց հետ խոչհուրդ չի տրվում աշխատել,ավելացնում է n;
 ...
 Function => --- Function ի մեջ ստեղծում ենք ցանկացաց կոդ,լոգիկա,գործողություն որի արդյունք վերադարցնում ենք return ով,ստանում է արգումենտներ,(պարամետրեր,կարող է և չստանալ որոնցով և կառող ենք կատարել գործողություններ։)
